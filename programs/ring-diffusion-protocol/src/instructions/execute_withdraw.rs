...
use crate::state::{PoolConfig, PoolState, KeyImageAccount, WithdrawRequest};
...
pub fn handler_execute_withdraw(
    ...
    msg!("Withdrew {} (fee {})", amount_after_fee, fee);
    Ok(())
}
